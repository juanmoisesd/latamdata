# latamdata
Python package: one-line access to 38 open research datasets from Latin America. pip install latamdata. OSF: https://osf.io/
...
```bibtex
@misc{delaserna2024_latamdata,
  author    = {de la Serna Tuya, Juan Moisés},
  title     = {Latamdata},
  year      = {2024},
  doi       = {10.5281/zenodo.19145316},
  url       = {https://github.com/juanmoisesd/latamdata},
  publisher = {Zenodo},
  license   = {CC0-1.0}
}
```

**APA:** de la Serna Tuya, J. M. (2024). *Latamdata*. https://doi.org/10.5281/zenodo.19145316
...
> de la Serna, J. M. (2026). *Latamdata*. Universidad Internacional de La Rioja (UNIR).
> https://github.com/juanmoisesd/latamdata 10.5281/zenodo.19145316

See `CITATION.cff` for formatted references.

## Overview
This repository contains data and resources related to **latamdata**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
